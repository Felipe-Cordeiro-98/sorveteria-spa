...
const Sobre = () => {
    return (
        ...
        <main className={style.main}>
          <section className={style.secao_banner_sobre}>
            <div className={style.titulo_banner_sobre}>
              <h1>A GELATERIA</h1>
            </div>
          </section>
  
          <section className={style.container_secao_sobre_nos}>
          ...
          <section className={style.container_secao_imagens}>
            <div>
